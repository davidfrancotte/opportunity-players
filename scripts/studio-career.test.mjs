...
import { careerActors,createCareerState,careerReducer,availableSlots,recommendations,appointmentPurposes } from '../lib/studio/career.ts';
import { initialProfile } from '../lib/studio/model.ts';
import { unconfirmedAppointments } from '../lib/studio/career.ts';
