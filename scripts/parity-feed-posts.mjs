...
try {
  ...
  await page.screenshot({ path: '/tmp/web-parity-full-post.png', animations: 'disabled' });
  await close();
  ...
  await close();
  await page.locator('.feed-list').screenshot({ path: '/tmp/web-parity-feed-excerpts.png', animations: 'disabled' });
