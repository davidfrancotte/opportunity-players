...
const features = [
  ...
  },
  {
    ...
    points: [
      'Connexions acceptées : échanges sans quota. Hors connexion, le quota porte sur les nouveaux interlocuteurs, pas sur les réponses.',
      'Demande de rendez-vous : le professionnel accepte avant de donner accès à ses disponibilités.',
      'Un seul agenda mensuel pour les matchs, les rendez-vous pro et les événements à suivre comme spectateur.',
