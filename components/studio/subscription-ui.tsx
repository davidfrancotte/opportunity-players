...
export function PlanStatus({ compact = false }: { compact?: boolean }) {
  ...
  return (
    <Link
      ...
      className={compact ? 'plan-status compact' : 'plan-status'}
    >
      ...
      <span>
        <strong>
          ...
          {premium ? 'Premium simulé' : 'Gratuit'}
        </strong>
        <small>
          {premium
...
export function LockedFeature({
  ...
  return (
    <aside className="locked-feature">
      ...
      <Button
        variant="secondary"
        onClick={() => dispatchSocial({ type: 'gate', reason })}
      >
        {reason === 'recipient'
...
export function UpgradeGate() {
  ...
  return (
    ...
    >
      <DialogContent
        className="studio-modal upgrade-modal"
        ...
        {reason !== 'recipient' && (
          <Button
            ...
            onClick={() => {
              close();
              router.push(
                '/espace/abonnement?retour=' + encodeURIComponent(pathname),
              );
            }}
          >
