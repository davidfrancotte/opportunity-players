...
export function CareerNav() {
  ...
  return (
    ...
    >
      ...
      <Link href="/espace/recrutement">
        <UsersRound size={17} />
        {c('Espace recrutement', 'Recruitment workspace')}
      </Link>
      <Link href="/espace/rendez-vous">
...
function DemoActor() {
  const { careerActor, careerActors, setCareerActor, dispatchCareer } =
    useDemo();
  const c = useCopy();
  return (
    <details
      className="career-demo"
      open={careerActor.id !== 'self' || undefined}
    >
      <summary>
        {careerActor.id === 'self'
          ? c(
              'Tester les deux côtés du parcours',
              'Test both sides of the workflow',
            )
      ...
      >
        {careerActors
          .filter((a) =>
            ['self', 'lea', 'noah', 'marc', 'horizon', 'arena'].includes(a.id),
          )
          .map((a) => (
...
function PremiumNotice() {
  ...
  return (
    <div className="career-empty">
      ...
      <Link href="/espace/abonnement" className="action primary">
    ...
    <section className="career-recommendations">
      <div className="career-section-title">
        ...
        <Button
          ...
          aria-label={c(
            'Ajuster mes recommandations',
            'Adjust my recommendations',
          )}
        >
            ...
            <div>
              ...
              <div className="career-actions">
                ...
                <Button
                  variant="ghost"
                  aria-label={
                    c('Masquer la suggestion : ', 'Hide suggestion: ') + m.name
                  }
      ...
      >
        ...
        >
          ...
          >
            <Option value="">
              {c('Mes sports du profil', 'My profile sports')}
            </Option>
            {sports.map((s) => (
      ...
      <Modal
        ...
        title={selected?.name || ''}
        description={c(
          'Profil fictif recommandé',
          'Recommended fictional profile',
        )}
      >
        {selected && (
          <div className="career-form">
            ...
            <Link href="/espace/reseau" className="action secondary">
...
export function ApplyButton({ offerId }: { offerId: string }) {
  ...
  if (app)
    return (
      <div className="career-form">
        ...
        <Link href="/espace/candidatures" className="action secondary">
  ...
  if (offer.owner === careerActor.id)
    return (
      <Link href="/espace/recrutement" className="action secondary">
      ...
      >
        <div className="career-form">
          ...
          <Button
            ...
            disabled={!consent}
            onClick={() =>
              dispatchCareer({ type: 'apply', id: uid(), offerId })
            }
          >
  ...
  return a.trial ? (
    <p className="career-trial">
      ...
      <span>
        ...
        <small>
          {c('Heure locale de votre appareil', 'Your device’s local time')}
        </small>
      </span>
    </p>
  ) : null;
...
export function ApplicationsPage() {
  ...
  const mine = career.applications.filter(
    (a) => a.candidate === careerActor.id,
  );
  const offers = career.offers.filter(
    (o) =>
      o.open &&
      o.audience === careerActor.category &&
      o.owner !== careerActor.id,
  );
  return (
    <CareerPage
        ...
        <div className="career-grid">
          {offers.map((o) => (
            <article className="career-card" key={o.id}>
              ...
              <p>{o.description}</p>
              <p className="career-note">
                {[o.level, o.position].filter(Boolean).join(' · ')}
              </p>
      ...
      {!access ? (
        ...
        <>
              ...
              <article key={o.id} className="career-card">
                ...
                {o.open && (
                  <Button
                    variant="ghost"
                    onClick={() =>
                      dispatchCareer({ type: 'close-offer', id: o.id })
                    }
                  >
          ...
          <div className="career-section-title">
            ...
            >
              <Option value="all">
                {c('Tous les statuts', 'All statuses')}
              </Option>
              {[
          ...
          >
            <form className="career-form" onSubmit={createOffer}>
              ...
              <Field
                name="position"
                label={c(
                  'Poste ou spécialité (facultatif)',
                  'Position or specialty (optional)',
                )}
                maxLength={80}
              />
              <Field
              ...
              <Submit>
                {c('Publier la recherche · démo', 'Publish vacancy · demo')}
              </Submit>
            </form>
          </Modal>
          <Modal
          ...
          >
            ...
            >
              ...
              <Submit>
                {c('Envoyer l’invitation · démo', 'Send invitation · demo')}
              </Submit>
            </form>
          </Modal>
          <Modal
  ...
  return (
    <>
      ...
      >
        ...
        {request
          ? c(
              'Suivre ma demande de rendez-vous',
              'Track my appointment request',
            )
        ...
        <div className="career-form">
          {request ? (
            <>
              ...
              <Link href="/espace/rendez-vous" className="action primary">
                ...
                {appointmentPurposes.map((p, i) => (
                  <Option key={p} value={p}>
                    {c(
                      p,
                      [
                        'Discover your coaching',
                        'Plan my progress',
                        'Discuss a sports project',
                      ][i],
                    )}
                  </Option>
                ))}
...
export function AppointmentsPage() {
  ...
  const sent = career.appointments.filter(
    (a) => a.requester === careerActor.id,
  );
  const incoming = career.appointments.filter(
    (a) => a.professional === careerActor.id,
  );
  const pro = careerActor.category === 'Professionnel';
  const name = (id: string) =>
    careerActors.find((a) => a.id === id)?.name || id;
  const ownSlots = career.slots.filter(
    (s) =>
      s.professional === careerActor.id && Date.parse(s.start) > Date.now(),
  );
  return (
    <CareerPage
            ...
            {ownSlots.map((s) => {
              ...
              return (
                <article className="career-card" key={s.id}>
                  ...
                  <p>
                    {s.place} ·{' '}
                    {booked ? c('Réservé', 'Booked') : c('Libre', 'Available')}
                  </p>
                  {!booked && (
                    <Button
                      variant="ghost"
                      onClick={() =>
                        dispatchCareer({ type: 'remove-slot', id: s.id })
                      }
                    >
            ...
            return (
              <article key={a.id} className="career-card">
                ...
                <p>
                  {c(
                    ...
                    [
                      ...
                      'Plan my progress',
                      'Discuss a sports project',
                    ][appointmentPurposes.indexOf(a.purpose)] || a.purpose,
                  )}
                </p>
                  ...
                  <div className="career-slots">
                    ...
                    {slots.map((s) => (
                      <Button
                        ...
                        key={s.id}
                        onClick={() =>
                          dispatchCareer({ type: 'book', id: a.id, slot: s.id })
                        }
                      >
                ...
                {!['declined', 'cancelled'].includes(a.status) && (
                  ...
                  >
                    {c(
                      'Annuler la demande / le rendez-vous',
  ...
  return (
    <section className="career-notices">
      <div className="career-section-title">
        ...
        <Button
          variant="ghost"
          onClick={() => dispatchCareer({ type: 'read' })}
        >
...
export function CareerAgenda() {
  ...
  const appointments = career.appointments
    .filter(
      (a) =>
        a.status === 'booked' &&
        [a.requester, a.professional].includes(careerActor.id),
    )
    .flatMap((a) => {
    ...
    .filter(
      (a) =>
        ...
        (a.candidate === careerActor.id ||
          career.offers.some(
            (o) => o.id === a.offerId && o.owner === careerActor.id,
          )),
    )
    .map((a) => ({
      start: a.trial!.start,
