  ...
  return (
    <section className="career-recommendations">
      ...
      {results.offers.map(({ offer: o, reasons }) => (
        <Link key={o.id} href="/espace/candidatures" className="career-suggestion">
...
export function AppointmentsPage() {
  ...
  return (
    ...
    >
      <Link href="/espace/agenda" className="action secondary">{c("Retour à l’agenda", "Back to calendar")}</Link>
      <div className="event-tabs">
...
export function CareerAgenda() {
  ...
  const trials = career.applications
    ...
    .map((a) => ({
      ...
      href: a.candidate === careerActor.id ? "/espace/candidatures" : "/espace/recrutement",
      id: a.id,
    }));
  return (
    <section className="career-notices">
