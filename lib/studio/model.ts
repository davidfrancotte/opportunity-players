...
export const photos = [
  { src: '/studio-images/coach.webp', label: 'Portrait du coach fictif' },
  { src: '/studio-images/padel-color.webp', label: 'Sur le terrain de padel' },
  { src: '/studio-images/tennis-color.webp', label: 'Un moment de tennis' },
  { src: '/studio-images/football-color.webp', label: 'L’esprit collectif' },
  { src: '/studio-images/basketball-color.webp', label: 'Sur le parquet' },
  {
    src: '/studio-images/athletics-color.webp',
    label: 'Le goût du dépassement',
  },
];
export const initialProfile: Profile = {
  ...
  photo: '/studio-images/coach.webp',
  media: [
    '/studio-images/padel-color.webp',
    '/studio-images/tennis-color.webp',
  ],
};
...
export function cvText(profile: Profile) {
  return [
    ...
    ...(profile.category === 'Sportif'
      ? [
          ...(profile.weightKg
            ? ['Poids : ' + measurementLabel(profile.weightKg, 'kg')]
            : []),
          ...(profile.heightCm
            ? ['Taille : ' + measurementLabel(profile.heightCm, 'cm')]
            : []),
        ]
      : []),
    '',
