...
export function createSocialState(): SocialState {
  return {
    ...
    posts: [
      ...
      {
        id: 'post-coach-job', category: 'Offres d’emploi', author: 'academie', name: 'Académie du Nord', role: 'Académie · Lille', avatar: '/studio-images/football-color.webp', sport: 'Football',
      ...
      {
        id: 'post-striker', category: 'Opportunités', opportunityCategory: 'Recrutement de joueurs', author: 'united', name: 'United Sport', role: 'Collectif · Charleroi', avatar: '/studio-images/football-color.webp', sport: 'Football',
